...
addEventHandler( "onPlayerSpawn", root,
	function( )
		...
		setPlayerStat ( source, 69, 30 )
		setPlayerStat ( source, 70, 50 )
		setPlayerStat ( source, 71, 999 )
		setPlayerStat ( source, 72, 50 )
		setPlayerStat ( source, 73, 0 )
		setPlayerStat ( source, 74, 0 )
		setPlayerStat ( source, 75, 0 )
		setPlayerStat ( source, 76, 0 )
		setPlayerStat ( source, 77, 999 )
		setPlayerStat ( source, 78, 999 )
		setPlayerStat ( source, 79, 0 )
	end
)
