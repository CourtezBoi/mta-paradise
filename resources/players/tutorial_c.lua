...
local texts =
{
	{ "Welcome", "Welcome to Urbanized Roleplay - let us just introduce the server, it won't take long!", 1 },
	...
	{ "The Setting", "This server is set in San Fierro surrounded by the bay and a bunch of small towns. The current year is " .. ( getRealTime().year + 1900 ) .. " - present time.", 1 },
	...
	{ "The End", "Now though that wasn't much, that's the end of our few tips. If you have any remaining questions or want to contact an admin, type /report.", 1 },
	{ "The actual End", "For more information, visit our forums at http://forum.urbanizedgaming.net", 1 },
}
