...
local texts =
{
	{ "Welcome", "Welcome to PogoKRAZY - let us just introduce the server, it won't take long!", 1 },
	...
	{ "The actual End", "For more information, visit our forums at http://forum.pogokrazy.net", 1 },
}
