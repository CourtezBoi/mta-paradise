...
addEventHandler( "onClientElementStreamIn", resourceRoot,
	function( )
		...
		exports.gui:hint( "San Fierro City Hall", "If you're in need of a job or want to change the one you have right now, talk to the Lady at the Front Desk. (( Press 'm' and Click her. ))" )
	end
)
